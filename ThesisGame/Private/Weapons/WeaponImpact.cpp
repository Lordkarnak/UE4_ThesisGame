...
// Sets default values
AWeaponImpact::AWeaponImpact(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
 	SetAutoDestroyWhenFinished(true);

}

void AWeaponImpact::PostInitializeComponents()
{
...
UParticleSystem* AWeaponImpact::GetImpactFX(TEnumAsByte<EPhysicalSurface> SurfaceType) const
{
...
USoundCue* AWeaponImpact::GetImpactSound(TEnumAsByte<EPhysicalSurface> SurfaceType) const
{
